...
public class FutsalTeamStatsDTO implements Serializable {
    ...
    public FutsalTeamStatsDTO(TeamDTO teamDTO, MatchDTO matchDTO) {
    ...
    public boolean equals(Object o) {
        ...
        FutsalTeamStatsDTO that = (FutsalTeamStatsDTO) o;
