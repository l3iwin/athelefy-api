...
@Entity
public class FootballPlayerStats implements Serializable {
    ...
    public FootballPlayerStats(Player player, Match match) {
        this.player = player;
        this.match = match;
    }
    ...
    public boolean equals(Object o) {
        ...
        FootballPlayerStats that = (FootballPlayerStats) o;
        return Objects.equals(id, that.id) && Objects.equals(minutesPlayed, that.minutesPlayed) && Objects.equals(goals, that.goals) && Objects.equals(assists, that.assists) && Objects.equals(passesCompleted, that.passesCompleted) && Objects.equals(passesAttempted, that.passesAttempted) && Objects.equals(shots, that.shots) && Objects.equals(shotsOnTarget, that.shotsOnTarget) && Objects.equals(foulsCommitted, that.foulsCommitted) && Objects.equals(foulsSuffered, that.foulsSuffered) && Objects.equals(yellowCards, that.yellowCards) && Objects.equals(redCard, that.redCard) && Objects.equals(match, that.match) && Objects.equals(player, that.player);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, minutesPlayed, goals, assists, passesCompleted, passesAttempted, shots, shotsOnTarget, foulsCommitted, foulsSuffered, yellowCards, redCard, match, player);
    }
}
